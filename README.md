Update of the following table: 2026-04-19 14:22 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.40 % | 797 |
| Present in 2 sources | 6.33 % | 12 363 |
| Present in 1 source | 93.26 % | 182 108 |
| Total | 100 % | 195 268 |
