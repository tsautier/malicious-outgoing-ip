...
# Statistics
Update of the following table: 2026-03-28 20:37 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.22 % | 404 |
| Present in 2 sources | 5.96 % | 10 883 |
| Present in 1 source | 93.80 % | 171 029 |
| Total | 100 % | 182 316 |
