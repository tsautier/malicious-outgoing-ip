...
# Statistics
Update of the following table: 2026-02-18 10:44 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.59 % | 1 030 |
| Present in 2 sources | 8.56 % | 14 727 |
| Present in 1 source | 90.83 % | 156 242 |
| Total | 100 % | 171 999 |
