...
# Statistics
Update of the following table: 2026-02-28 10:37 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.81 % | 1 466 |
| Present in 2 sources | 8.75 % | 15 666 |
| Present in 1 source | 90.42 % | 161 715 |
| Total | 100 % | 178 847 |
