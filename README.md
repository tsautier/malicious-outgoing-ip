Update of the following table: 2026-04-26 17:20 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.74 % | 1 647 |
| Present in 2 sources | 9.28 % | 20 646 |
| Present in 1 source | 89.97 % | 200 120 |
| Total | 100 % | 222 413 |
